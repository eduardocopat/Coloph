...
module ActionController
  ...
  #   end
  #
  # Read more features writing ERB and Builder templates in ActionView::Base.
  #
  # == Redirects
  #
  ...
  #
  # Learn more features <tt>redirect_to</tt> and what options you have in ActionController::Redirecting.
  #
