...
module ActiveResource
  ...
  # You can read more features each of these methods in their respective documentation.
  #
  # === Custom REST methods
  #
  ...
  #
  # Learn more features Active Resource's validation features in the ActiveResource::Validations documentation.
  #
  # === Timeouts
  #
