class SpecializationsController < ApplicationController
  #load_and_authorize_resource :specialization

  # GET /specializations
  # GET /specializations.json
  def index
    @specializations = Specialization.where(:diagram_id => params[:diagram_id])
  ...
  def create
    ...
    respond_to do |format|
      if @specialization.save
        ...
        format.json { render json: @specialization, status: :created }
      else
