...
"%":"HTMLTemplateElement"},
FB:{
"":"qE;Si:cols%,oc:name=,qB:selectionStart=,P:value=",
Ir:function(a,b,c,d){return a.setSelectionRange(b,c,d)},
NS:function(a,b,c){return a.setSelectionRange(b,c)},
"%":"HTMLTextAreaElement"},
w6:{
...
id:{
"":"a;",
skZ:function(a,b){this.hV(a,"font-family",b,"")},
...
"":"Tp:8;",
call$1:function(a){var z=J.x(a)
return typeof a==="object"&&a!==null&&!!z.$iscv}}}],["relationalAlgebra","file:///C:/Users/AVELL/Dropbox/Coloph/public/RelationalAlgebra/web/lib/relationalAlgebraLib.dart",,E,{
"":"",
h2:{
"":"a;tP,bM,Ea,es",
wr:function(){this.Ea=J.Nj(this.tP,0,this.bM)
var z=this.tP
this.es=C.xB.Nj(z,this.bM,J.U6(z).gB(z))},
static:{"":"eO,Y6,e0,uh,vO,fg,op,Jk,ps,Fx,tf,ib"}}}],["","file:///C:/Users/AVELL/Dropbox/Coloph/public/RelationalAlgebra/web/relationalAlgebra.dart",,A,{
"":"",
Iq:[function(){$.VW=document.querySelector("#query_exercise_answer_answer")
$.JR=new E.h2(null,null,null,null)
A.NM()
P.JS("Teste")
A.uK()},"call$0","eE",0,0,0],
NM:function(){J.Sm($.VW.style,"cambria")
J.qL($.VW.style,"18px")},
uK:function(){var z=J.Vg(document.querySelector("#projection_operator_button"))
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(new A.MV()),z.Sg),[H.Kp(z,0)]).Zz()
z=J.Vg(document.querySelector("#selection_operator_button"))
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(new A.Qg()),z.Sg),[H.Kp(z,0)]).Zz()
z=J.Vg(document.querySelector("#union_operator_button"))
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(new A.CB()),z.Sg),[H.Kp(z,0)]).Zz()
z=J.Vg(document.querySelector("#intersection_operator_button"))
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(new A.Pm()),z.Sg),[H.Kp(z,0)]).Zz()
z=J.Vg(document.querySelector("#difference_operator_button"))
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(new A.Ct()),z.Sg),[H.Kp(z,0)]).Zz()
z=J.Vg(document.querySelector("#division_operator_button"))
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(new A.Pc()),z.Sg),[H.Kp(z,0)]).Zz()
z=J.Vg(document.querySelector("#natural_join_operator_button"))
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(new A.YA()),z.Sg),[H.Kp(z,0)]).Zz()
z=J.Vg(document.querySelector("#left_outer_join_operator_button"))
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(new A.Km()),z.Sg),[H.Kp(z,0)]).Zz()
z=J.Vg(document.querySelector("#right_outer_join_operator_button"))
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(new A.Ik()),z.Sg),[H.Kp(z,0)]).Zz()
z=J.Vg(document.querySelector("#full_outer_join_operator_button"))
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(new A.Bb()),z.Sg),[H.Kp(z,0)]).Zz()
z=J.Vg(document.querySelector("#rename_operator_button"))
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(new A.la()),z.Sg),[H.Kp(z,0)]).Zz()
z=J.Vg(document.querySelector("#designation_operator_button"))
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(new A.MV7()),z.Sg),[H.Kp(z,0)]).Zz()},
...
A.NM()
J.Qy($.VW,z)
J.OG(document.querySelector("#query_exercise_answer_answer_div")).h(0,$.VW)
$.VW.focus()
z=$.VW
x=$.Jg
if(typeof x!=="number")return x.g();++x
J.x9(z,x,x)},
tu:function(){$.Jg=J.Jn($.VW)
var z=$.JR
document.querySelector("#query_exercise_answer_answer")
z.tP=J.Vm($.VW)
$.JR.bM=$.Jg},
MV:{
"":"Tp:20;",
...
z=$.JR
z.wr()
z.tP=C.xB.g(J.WB(z.Ea,"&rho;"),z.es)
A.FV()}},
MV7:{
"":"Tp:20;",
call$1:function(a){var z
...
init.metadata=[{func:"X0",void:true},{func:"Gl",ret:J.kn,args:[null,null]},{func:"bX",ret:J.im,args:[null]},{func:"E0",ret:J.kn,args:[P.a,P.a]},{func:"ZY",ret:J.im,args:[P.a]},{func:"zy",ret:J.kn,args:[W.cv,J.O,J.O,W.JQ]},{func:"NT"},{func:"bh",args:[null,null]},{func:"aB",args:[null]},{func:"TS",args:[null,J.O]},{func:"uO",args:[J.O]},{func:"KV",void:true,args:[null],opt:[P.mE]},,{func:"BG",args:[null],opt:[null]},{func:"Uf",ret:J.kn},{func:"bb",args:[null,P.mE]},{func:"jQ",args:[P.wv,null]},{func:"Pt",ret:J.O,args:[J.im]},{func:"YI",void:true,args:[P.a]},{func:"qu",void:true,args:[W.KV]},{func:"dG",args:[W.ea]},];$=null
...
if($desc instanceof Array)$desc=$desc[1]
FB.prototype=$desc
FB.prototype.gSi=function(receiver){return receiver.cols}
FB.prototype.sSi=function(receiver,v){return receiver.cols=v}
...
if($desc instanceof Array)$desc=$desc[1]
Zf.prototype=$desc
function h2(tP,bM,Ea,es){this.tP=tP
this.bM=bM
this.Ea=Ea
this.es=es}h2.builtin$cls="h2"
...
if($desc instanceof Array)$desc=$desc[1]
la.prototype=$desc
function MV7(){}MV7.builtin$cls="MV7"
if(!"name" in MV7)MV7.name="MV7"
$desc=$collectedClasses.MV7
if($desc instanceof Array)$desc=$desc[1]
MV7.prototype=$desc
return[qE,Gh,rK,fY,Mr,lJ,P2,nB,i3,it,QP,IF,n6,Ny,nx,QQ,fW,y4,d7,Um,oJ,He,HA,vH,xO,Em,NW,rV,Wy,QF,hs,cm,BK,ae,cv,Fs,hY,ea,D0,as,Aa,u5,h4,iG,jP,Ax,xf,xn,Vb,QH,ST,X2,tb,pA,Mi,HL,In,wP,eP,A6,Og,u8,M6,El,mC,SV,aB,fJ,Ih,Vh,rC,ZY,cx,Ee,Qb,PG,xe,Hw,bn,eC,xI,Aj,oU,eY,KV,BH,KY,G7,l9,Ql,wL,bP,FH,SN,HD,ni,rR,qj,nC,KR,ew,fs,u2,bX,lr,ip,iQ,qI,Ea,lp,kd,I0,yN,Cp,ua,HN,Ul,KK,ii,fq,i9,qk,GI,Tb,Iv,BT,yY,kJ,FB,xV,Pe,y6,RH,Kn,Z2,w6,BR,vw,aG,fA,Oi,UM,hq,WS,NL,yp,c1,Mq,Nf,Nc,Mx,rh,Zv,Q7,yK,Dh,ZJ,mU,eZ,IT,nV,ui,D6,DQ,nL,xL,es,jw,lv,pf,NV,W1,zo,wf,TU,ih,Nd,zp,Xu,lu,tk,me,oB,Ah,d4,MI,Ub,bM,pQ,um,ju,OE,N9,BA,d0,tp,rE,CC,PQ,uz,Yd,p8,AD,Gr,Gq,GH,To,jr,j2,jf,rQ,Lx,f6,d5,hy,r8,aS,CG,UN,MT,Rk,Eo,YS,ox,ZD,vt,cu,BD,vR,j8,Ja,zI,cB,LQ,yR,HP,fa,l4,Et,QS,Pi,qO,xt,tG,P0,xl,Xr,Sl,Qm,ET,V6,FK,Gv,kn,YE,Ue,iC,is,Q,P,im,VA,O,PK,JO,O2,aX,cC,RA,IY,JH,jl,Iy,JM,Ua,ns,yo,Bj,NO,II,fP,X1,HU,oo,OW,Tf,iY,yH,FA,Av,ku,FD,Zr,ZQ,az,vV,Am,XO,dr,TL,KX,uZ,OQ,Tp,Bp,v,Eq,lb,tD,hJ,dC,wN,VX,aL,a7,i1,xy,MH,A8,U5,SO,SU,Ca,vs,da,xw,dm,rq,RW,YP,jZ,FZ,OM,qh,lz,Rl,Jb,M4,B5,PI,MO,nP,dR,uR,fZ,TF,K5,Cg,Hs,pK,eM,R8,k6,oi,fG,EQ,YB,a1,db,i5,N6,jg,YO,oz,b6,tj,zQ,u3,mW,ar,lD,W0,Sw,o0,CL,a6,P7,DW,Ge,LK,AT,bJ,ub,ds,lj,UV,VS,t7,HG,kM,An,c8,a,mE,Rn,wv,M0,BV,id,VG,Cv,zL,ec,e7,dx,kE,hm,x5,tJ,i7,I4,Fk,RO,eu,xC,JQ,Pb,vD,mD,Eg,m6,ct,IA,Ow,W9,rB,kF,mk,MM,fm,IU,b0,Pg,Ob,GV,As,N7,uQ,D7,Zf,h2,MV,Qg,CB,Pm,Ct,Pc,YA,Km,Ik,Bb,la,MV7]}